...
//< image_set
VkPipelineLayoutCreateInfo vkinit::pipeline_layout_create_info() //this is where we store the shader info ( push constants and descriptor sets )
{
...
VkPipelineInputAssemblyStateCreateInfo vkinit::input_assembly_create_info(VkPrimitiveTopology topology) //lines, tri, and quads
{
...
VkPipelineRasterizationStateCreateInfo vkinit::rasterizaion_state_create_info(VkPolygonMode polygonMode) //lines, points, fill
{
